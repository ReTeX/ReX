use font_types::{KernRecord, KernTable, FontUnit};

pub static KERNING_TABLE: [(u32, KernRecord); 29] = [
    (0x41, KernRecord { // A
        top_right: Some(KernTable {
            correction_heights: &[ fontunit!(275) ],
            kern_values: &[ fontunit!(-100), fontunit!(-150) ],
        }),
        top_left: None,
        bottom_right: Some(KernTable {
            correction_heights: &[ fontunit!(0) ],
            kern_values: &[ fontunit!(50), fontunit!(0) ],
        }),
        bottom_left: None,
    }),
    (0x46, KernRecord { // F
        ...
        bottom_right: Some(KernTable {
            correction_heights: &[ fontunit!(0) ],
            kern_values: &[ fontunit!(-150), fontunit!(0) ],
        }),
        bottom_left: None,
    }),
    (0x4C, KernRecord { // L
    ...
    (0x54, KernRecord { // T
        ...
        bottom_right: Some(KernTable {
            correction_heights: &[ fontunit!(0) ],
            kern_values: &[ fontunit!(-100), fontunit!(0) ],
        }),
        bottom_left: None,
    }),
    (0x56, KernRecord { // V
    ...
    (0x3A4, KernRecord { // uni03A4
        ...
        bottom_right: Some(KernTable {
            correction_heights: &[ fontunit!(0) ],
            kern_values: &[ fontunit!(-110), fontunit!(0) ],
        }),
        bottom_left: None,
    }),
    (0x3A5, KernRecord { // uni03A5
        ...
        bottom_right: Some(KernTable {
            correction_heights: &[ fontunit!(0) ],
            kern_values: &[ fontunit!(-120), fontunit!(0) ],
        }),
        bottom_left: None,
    }),
    ...
    (0x1D400, KernRecord { // u1D400
        ...
        bottom_right: Some(KernTable {
            correction_heights: &[ fontunit!(0) ],
            kern_values: &[ fontunit!(30), fontunit!(0) ],
        }),
        bottom_left: None,
    }),
